...
use SerendipitySwow\Nsq\Exception\ConsumerException;
...
final class Consumer extends Connection
{
     ...
     * @internal
     */
    public function req(string $id, int $timeout)
    {
        --$this->rdy;
